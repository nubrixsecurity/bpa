function Invoke-MicrosoftGraphCredentials($Credentials)
{
	...
	if ((Get-MgContext) -ne $null)
	{
		...
		$OrgName = (((get-aztenant | Select-Object -ExpandProperty domains) |  Where-Object { ($_ -like "*.onmicrosoft.com") -and ($_ -notlike "*mail.onmicrosoft.com") }) -split '.onmicrosoft.com')[0]
		return $OrgName
	}
	else
	{
